...
INSERT INTO public.recall_two_siders (id, subject, emoji, question, for_label, against_label, available, sort_order) VALUES
  ('eco-tariffs', 'Economics', '📈', 'Evaluate the case for and against the use of protectionist tariffs.', 'FOR tariffs', 'AGAINST tariffs', true, 1),
  ('eco-minimum-wage', 'Economics', '📈', 'Discuss whether the government should raise the national minimum wage.', 'FOR raising it', 'AGAINST raising it', true, 2)
